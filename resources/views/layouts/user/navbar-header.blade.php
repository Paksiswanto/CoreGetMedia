        ...
        <nav class="navbar navbar-expand-lg">
            ...
            <div class="collapse navbar-collapse">
                <ul class="navbar-nav mx-auto">
                    <li class="nav-item">
                        <a href="javascript:void(0)" class="dropdown-toggle nav-link active"> Home </a>
                    ...
                    <li class="nav-item">
                        <a href="javascript:void(0)" class="dropdown-toggle nav-link"> Business </a>
                        <ul class="dropdown-menu">
                            <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a href="javascript:void(0)" class="dropdown-toggle nav-link"> Politics </a>
                        <ul class="dropdown-menu">
                            <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a href="javascript:void(0)" class="dropdown-toggle nav-link"> Video </a>
                        <ul class="dropdown-menu">
                            <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a href="javascript:void(0)" class="dropdown-toggle nav-link"> Sports </a>
                        <ul class="dropdown-menu">
                            <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a href="javascript:void(0)" class="nav-link dropdown-toggle"> Shop </a>
                        <ul class="dropdown-menu">
                            <li class="nav-item">
