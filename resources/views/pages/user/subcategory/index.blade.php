                            ...
                            <div class="news-card-five mb-4">
                                ...
                                <div class="news-card-info">
                                    ...
                                    <ul class="news-metainfo list-style">
                                        <li>
                                            <i class="fi fi-rr-calendar-minus"></i>
                                            <a href="news-by-date.html">{{ \Carbon\Carbon::parse($data->date)->translatedFormat('d F Y') }}</a>
                                        </li>
                                        <li>
                                            <i class="fi fi-rr-eye"></i>
                                            <a href="news-by-dateus">{{ $data->newsViews_count ? $data->newsViews_count : '0' }}x dilihat</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="sidebar">
                        ...
                        <div class="sidebar-widget">
                            ...
                            @forelse ($newsPopulars as $trending)
                                <div class="news-card-three mb-3 d-flex">
                                    <div class="news-card-img" style="height: 100px; width: 100px">
                                        <img src="{{ asset('storage/' . $trending->image) }}" alt="Image" />
                                    </div>
                                    <div class="news-card-info ms-3">
                                        <h3><a href="business-details.html">{{ $trending->name }}</a></h3>
                                        <ul class="news-metainfo list-style d-flex">
                                            <li>
                                                <i class="fi fi-rr-calendar-minus"></i>
                                                <a href="news-by-date.html" style="font-size: 15px;">
                                                    {{ \Carbon\Carbon::parse($trending->date)->translatedFormat('d F Y') }}
                                                </a>
                                            </li>
                                            <li>
                                                <i class="fi fi-rr-eye"></i>
                                                <a href="news-by-dateus" style="font-size: 15px;">
                                                    {{ $trending->newsViews_count ? $trending->newsViews_count : '0' }}x dilihat
                                                </a>
                                            </li>
                                        </ul>
                                    </div>
