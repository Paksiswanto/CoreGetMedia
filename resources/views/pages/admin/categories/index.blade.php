            ...
            <table id="category-table" class="table border text-nowrap customize-table mb-0 align-middle">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>Pendidikan</td>
                        <td>3</td>
                        <td> <button style="background-color: #FFD643;" class="btn btn-sm btn-edit text-white me-2">
                        ...
                        <button type="submit" style="background-color: #EF6E6E"
                            ...
                            <a data-bs-toggle="tooltip" title="Sub Category" class="btn btn-sm text-white" style="background-color: #1EBB9E;">
