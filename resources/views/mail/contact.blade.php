                        ...
                        <tr>
                          ...
                          >
                            <div
                              ...
                              "
                            >
                              <p style="color: #000000;">{{ \Carbon\Carbon::now()->locale('id_ID')->isoFormat('D MMMM Y') }}</p>
                              ...
                              <h2
                                ...
                                "
                              >
                                {{ $data['name'] }} mengirimkan sebuah pesan!
                              </h2>
                              <h4 style="margin: 0px; font-weight: 800; color: #000;">Pengirim</h4>
                              <p style="margin: 0px; color: #000;">Nama: {{ $data['name'] }}</p>
                              <p style="margin: 0px; color: #000;">Email: {{ $data['email'] }}</p>
                              <p style="margin: 0px; color: #000000;">Telepon: {{ $data['no_telp'] }}</p>
